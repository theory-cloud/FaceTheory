...
## Install v0.5.6-rc.1 <!-- x-release-please-version -->
...
- AppTheory runtime: `https://github.com/theory-cloud/AppTheory/releases/download/v0.24.5/theory-cloud-apptheory-0.24.5.tgz`
- AppTheory CDK: `https://github.com/theory-cloud/AppTheory/releases/download/v0.24.5/theory-cloud-apptheory-cdk-0.24.5.tgz`
...
- [Getting Started](https://github.com/theory-cloud/FaceTheory/blob/v0.5.6-rc.1/docs/getting-started.md)
- [API Reference](https://github.com/theory-cloud/FaceTheory/blob/v0.5.6-rc.1/docs/api-reference.md)
- [Core Patterns](https://github.com/theory-cloud/FaceTheory/blob/v0.5.6-rc.1/docs/core-patterns.md)
- [Testing Guide](https://github.com/theory-cloud/FaceTheory/blob/v0.5.6-rc.1/docs/testing-guide.md)
- [CDK And AWS Notes](https://github.com/theory-cloud/FaceTheory/blob/v0.5.6-rc.1/docs/cdk/README.md)
<!-- x-release-please-end -->

The `v0.5.6-rc.1` release also includes the matching `facetheory-reference-${FACETHEORY_VERSION}.tar.gz` bundle with the canonical docs, runnable examples, and reference deployment stacks. <!-- x-release-please-version -->
