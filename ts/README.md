...
## Install v1.0.0-rc.5 <!-- x-release-please-version -->

```bash
export FACETHEORY_VERSION=1.0.0-rc.5 # x-release-please-version
...
- AppTheory runtime: `https://github.com/theory-cloud/AppTheory/releases/download/v1.1.1/theory-cloud-apptheory-1.1.1.tgz`
- AppTheory CDK: `https://github.com/theory-cloud/AppTheory/releases/download/v1.1.1/theory-cloud-apptheory-cdk-1.1.1.tgz`
- TableTheory runtime: `https://github.com/theory-cloud/TableTheory/releases/download/v1.7.1/theory-cloud-tabletheory-ts-1.7.1.tgz`
...
- [Getting Started](https://github.com/theory-cloud/FaceTheory/blob/v1.0.0-rc.5/docs/getting-started.md)
- [API Reference](https://github.com/theory-cloud/FaceTheory/blob/v1.0.0-rc.5/docs/api-reference.md)
- [Core Patterns](https://github.com/theory-cloud/FaceTheory/blob/v1.0.0-rc.5/docs/core-patterns.md)
- [Testing Guide](https://github.com/theory-cloud/FaceTheory/blob/v1.0.0-rc.5/docs/testing-guide.md)
- [CDK And AWS Notes](https://github.com/theory-cloud/FaceTheory/blob/v1.0.0-rc.5/docs/cdk/README.md)
<!-- x-release-please-end -->

The `v1.0.0-rc.5` release also includes the matching `facetheory-reference-${FACETHEORY_VERSION}.tar.gz` bundle with the canonical docs, runnable examples, and reference deployment stacks. <!-- x-release-please-version -->
