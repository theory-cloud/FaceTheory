...
/**
 * A single entry in the navigation tree consumed by the shell primitives.
 * One level of nesting (groups with children) is typical for control-plane
 * surfaces; deeper trees are supported but should be used sparingly.
 */
