...
# =============================================================
# FaceTheory · docs version override generator
#
...
# runtime install commands always match the deployed release instead of
# the hand-maintained pins in docs/_config.yml (`version_pill: "v3.x"`,
...
def main(argv)
  ...
  OptionParser.new do |opts|
    ...
    opts.on("--tag TAG", "Release tag to stamp (e.g. v4.0.8)") do |tag|
      options[:tag] = tag
    end
  ...
  abort "error: --tag is required (e.g. v4.0.8)" if tag.nil? || tag.empty?
