...
- AppTheory (TypeScript): `v1.11.0`
- AppTheory (CDK): `v1.11.0`
...
- **`fast-uri`** — AppTheory CDK `v1.11.0` requires `aws-cdk-lib@2.254.0`, and the infra example
...
{
  "devDependencies": {
    "@theory-cloud/apptheory": "https://github.com/theory-cloud/AppTheory/releases/download/v1.11.0/theory-cloud-apptheory-1.11.0.tgz",
