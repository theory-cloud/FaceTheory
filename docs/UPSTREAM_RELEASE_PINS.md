...
- AppTheory (TypeScript): `v0.25.0`
- AppTheory (CDK): `v0.25.0`
...
npm install --save-exact \
  https://github.com/theory-cloud/AppTheory/releases/download/v0.25.0/theory-cloud-apptheory-cdk-0.25.0.tgz
```
...
{
  "devDependencies": {
    "@theory-cloud/apptheory": "https://github.com/theory-cloud/AppTheory/releases/download/v0.25.0/theory-cloud-apptheory-0.25.0.tgz",
